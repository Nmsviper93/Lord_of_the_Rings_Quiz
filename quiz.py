...
def questions(question_num):
    ...
    return render_template('questions.html', question=question_text, alternatives=alternatives, question_num=session['current_question'] + 1, total_questions = total_questions)
